...
#ip_list_roles是一个数组变量(用小括号()括起来）对应ip_list的各栏位，ip_range_roles对应ip_range,有几个ip就有几组,有几个端口就有几个roles位，而每一组又对应所有的端口,端口位为1则对该ip应用规则（默认接受)
#log_roles定义是否开启防火墙日志,对应ports中的各栏位，值为1则开启对应端口的防火墙日志
ports="80 8080 8091 22"
ip_list="192.168.8.254 192.168.2.254 10.10.10.2"
ip_list_roles=("1 0 1 0" "0 1 1 0" "0 0 1 0")
ip_range="10.10.10.5-10.10.10.30 172.25.254.10-172.25.254.20"
ip_range_roles=("1 1 1 1" "0 0 0 1")
log_roles="1 1 1 1"
